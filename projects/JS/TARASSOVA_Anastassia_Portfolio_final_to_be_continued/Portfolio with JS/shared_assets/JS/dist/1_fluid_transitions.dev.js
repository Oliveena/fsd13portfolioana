...
$(document).ready(function () {
  $('a').on('click', function (e) {
    e.preventDefault(); // declaring target URL (initialization)

    var url = $(this).attr('href'); // adding loading class to new URL

    $('body').addClass('loading'); // after 1s, go to new page
