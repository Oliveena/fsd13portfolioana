...
$(document).ready(function () {
    ...
    $('#contactForm').on('submit', function (event) {
        ...
        const emailRegex = /^[A-Za-z0-9\s.,'-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/;
...
$(document).ready(function () {
    ...
    $('#bookForm').on('submit', function (event) {
        ...
        // user is allowed to submit empty form, after all, they're allowed to edit it post-push

        // validation (idem as form above)
        const bookTitleRegex = /^[A-Za-z0-9\s.,'-]+$/;
        ...
        const bookAuthorRegex = /^[A-Za-z0-9\s.,'-]+$/;
